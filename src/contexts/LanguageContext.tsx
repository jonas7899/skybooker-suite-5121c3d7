...
export const translations: Translations = {
  ...
  'admin.operators.manageStaff': { hu: 'Staff kezelése', en: 'Manage Staff' },
  'admin.operators.manageStaffTitle': { hu: 'Staff tagok kezelése', en: 'Manage Staff Members' },
  'admin.operators.manageStaffDescription': { hu: 'Staff tagok hozzáadása és eltávolítása az operátorhoz:', en: 'Add and remove staff members for operator:' },
  'admin.operators.staffMembers': { hu: 'Staff tagok', en: 'Staff Members' },
  'admin.operators.addStaff': { hu: 'Staff hozzáadása', en: 'Add Staff' },
  'admin.operators.addStaffTitle': { hu: 'Staff tag hozzáadása', en: 'Add Staff Member' },
  'admin.operators.addStaffDescription': { hu: 'Válassz ki egy felhasználót, aki staff tag lesz ennél az operátornál:', en: 'Select a user to be a staff member for this operator:' },
  'admin.operators.noStaffMembers': { hu: 'Még nincs staff tag hozzárendelve', en: 'No staff members assigned yet' },
  'admin.operators.staffAdded': { hu: 'Staff tag sikeresen hozzáadva', en: 'Staff member added successfully' },
  'admin.operators.staffAlreadyAssigned': { hu: 'Ez a felhasználó már hozzá van rendelve', en: 'This user is already assigned' },
  'admin.operators.removeStaff': { hu: 'Staff eltávolítása', en: 'Remove Staff' },
  ...
  'admin.operators.manageSubscription': { hu: 'Előfizetés kezelése', en: 'Manage Subscription' },
  'admin.operators.manageSubscriptionTitle': { hu: 'Előfizetés kezelése', en: 'Manage Subscription' },
  'admin.operators.manageSubscriptionDescription': { hu: 'Előfizetési csomag és lejárati dátum beállítása:', en: 'Set subscription plan and expiry date for:' },
  'admin.operators.subscriptionPlan': { hu: 'Előfizetési csomag', en: 'Subscription Plan' },
  'admin.operators.subscriptionStatus': { hu: 'Előfizetés állapota', en: 'Subscription Status' },
  'admin.operators.subscriptionExpiry': { hu: 'Lejárati dátum', en: 'Expiry Date' },
  'admin.operators.subscriptionPrice': { hu: 'Előfizetési díj', en: 'Subscription Price' },
  'admin.operators.subscriptionUpdated': { hu: 'Előfizetés sikeresen frissítve', en: 'Subscription updated successfully' },
  'admin.operators.planMonthly': { hu: 'Havi', en: 'Monthly' },
  'admin.operators.planYearly': { hu: 'Éves', en: 'Yearly' },
  'admin.operators.subscriptionTrial': { hu: 'Próba', en: 'Trial' },
  'admin.operators.subscriptionActive': { hu: 'Aktív', en: 'Active' },
  'admin.operators.subscriptionExpired': { hu: 'Lejárt', en: 'Expired' },
  'admin.operators.subscriptionCancelled': { hu: 'Lemondva', en: 'Cancelled' },
  'admin.operators.month': { hu: 'hónap', en: 'month' },
  'admin.operators.months': { hu: 'hónap', en: 'months' },
  'admin.operators.year': { hu: 'év', en: 'year' },
  'admin.operators.activateOperator': { hu: 'Operátor aktiválása', en: 'Activate Operator' },
  'admin.operators.deactivateOperator': { hu: 'Operátor deaktiválása', en: 'Deactivate Operator' },
  'admin.operators.operatorActivated': { hu: 'Operátor sikeresen aktiválva', en: 'Operator activated successfully' },
  'admin.operators.operatorDeactivated': { hu: 'Operátor sikeresen deaktiválva', en: 'Operator deactivated successfully' },
