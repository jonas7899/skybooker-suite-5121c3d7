...
export const translations: Translations = {
  ...
  'admin.operators.removeAdmin': { hu: 'Admin eltávolítása', en: 'Remove Admin' },
  'admin.operators.removeAdminTitle': { hu: 'Admin eltávolítása', en: 'Remove Admin' },
  'admin.operators.removeAdminDescription': { hu: 'Biztosan el szeretnéd távolítani ezt az admint az operátorból?', en: 'Are you sure you want to remove this admin from the operator?' },
  'admin.operators.adminRemoved': { hu: 'Admin sikeresen eltávolítva', en: 'Admin removed successfully' },
